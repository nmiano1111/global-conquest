...
|---|---|---|---|
| `--strategies` | yes | — | Comma-separated strategy ID per seat, e.g. `basic-v1,scored-v1,scored-v1`. Fixed for every game in the tournament. Available IDs: `basic-v1`, `scored-v1`, `angry-v1`, `cluster-v1`, `pixie-v1`, `quo-v1`, `boscoe-v1` (Lux Delux-inspired personas — see [`project-docs/bot_player/proposals/Lux_Delux_AI_Research_Notes.md`](../../../project-docs/bot_player/proposals/Lux_Delux_AI_Research_Notes.md)). |
