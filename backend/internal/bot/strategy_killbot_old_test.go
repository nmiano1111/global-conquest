...
func TestKillbotOldStrategyTradesCardsVoluntarily(t *testing.T) {
	g, p0 := newTestGame(t)
...
func TestKillbotOldStrategyReinforcePlacesTowardKillTarget(t *testing.T) {
	g, p0 := newTestGame(t)
	g.Phase = risk.PhaseReinforce
...
func TestKillbotOldStrategyAttackFiresKillBranch(t *testing.T) {
	g, p0 := newTestGame(t)
...
func TestKillbotOldStrategyAttackFallsBackToPixieStyleWhenNoKillTarget(t *testing.T) {
	g, p0 := newTestGame(t)
	g.Phase = risk.PhaseAttack
...
func TestKillbotOldStrategyAttackEndsWhenNothingQualifies(t *testing.T) {
	g, p0 := newTestGame(t)
	g.Phase = risk.PhaseAttack
...
func TestKillbotOldStrategyOccupyDelegatesToPixieLogic(t *testing.T) {
	g, p0 := newTestGame(t)
...
func TestKillbotOldStrategyFortifyPrefersMostEnemyNeighborDestination(t *testing.T) {
	g, p0 := newTestGame(t)
