                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpapi.loginReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/games": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Max games returned",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpapi.createGameReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/games/{id}/state": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update game state request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpapi.updateGameStateReq"
                        }
                    }
                ],
                "responses": {
